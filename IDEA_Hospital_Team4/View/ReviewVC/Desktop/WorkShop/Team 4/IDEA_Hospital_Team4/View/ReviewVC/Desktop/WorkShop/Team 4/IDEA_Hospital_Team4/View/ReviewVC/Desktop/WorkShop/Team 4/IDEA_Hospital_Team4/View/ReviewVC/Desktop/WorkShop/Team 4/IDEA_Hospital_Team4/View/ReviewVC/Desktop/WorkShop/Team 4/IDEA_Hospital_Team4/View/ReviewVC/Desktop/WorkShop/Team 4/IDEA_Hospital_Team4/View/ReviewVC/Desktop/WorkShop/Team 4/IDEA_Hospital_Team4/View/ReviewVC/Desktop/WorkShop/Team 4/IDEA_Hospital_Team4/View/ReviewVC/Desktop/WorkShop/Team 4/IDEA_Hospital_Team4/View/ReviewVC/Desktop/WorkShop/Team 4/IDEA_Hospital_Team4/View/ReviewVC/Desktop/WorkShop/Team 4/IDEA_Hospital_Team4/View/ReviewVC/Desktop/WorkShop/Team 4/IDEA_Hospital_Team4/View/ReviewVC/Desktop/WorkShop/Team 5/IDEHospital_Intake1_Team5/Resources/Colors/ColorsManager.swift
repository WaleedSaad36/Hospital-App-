...
internal struct ColorName {
  ...
  /// <span style="display:block;width:3em;height:2em;border:1px solid black;background:#d3c1da"></span>
  /// Alpha: 100% <br/> (0xd3c1daff)
  internal static let placholderColor = ColorName(rgbaValue: 0xd3c1daff)
  /// <span style="display:block;width:3em;height:2em;border:1px solid black;background:#4e0e69"></span>
  /// Alpha: 100% <br/> (0x4e0e69ff)
  internal static let primaryColor = ColorName(rgbaValue: 0x4e0e69ff)
