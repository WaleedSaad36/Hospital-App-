...
//            self.isSelected = true
            ...
            self.backgroundColor = UIColor(hexString: "#b7b7b7")
        }else{
            self.isSelected = false
            self.isUserInteractionEnabled = true
            self.backgroundColor = UIColor(hexString: "#0f86b9")
        }
...
extension TimeCollectionViewCell{
    private func setState() {
        backgroundColor = isSelected ? UIColor(hexString: "#001867") : UIColor(hexString: "#0f86b9")
    }
